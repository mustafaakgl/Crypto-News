...
const de = {
  ...
  exchangeVolume: {
    ...
    colAllPairs24h: "Alle Paare, 24 Std.",
    colTracked24h: "Erfasste Paare, 24 Std.",
    colTrackedShare: "Anteil erfasst",
    colStableSwap24h: "Stable ↔ Stable",
    colPairsCounted: "Paare",
    allPairsNote:
      "Alle Spot-Paare jeder Börse in den letzten 24 Stunden (gleitend, nicht der gestrige UTC-Tag), aus einer einzigen Ticker-Momentaufnahme. Der erfasste Anteil zeigt, wie viel davon die Hauptpaare der anderen Ansichten abdecken, gemessen an derselben Momentaufnahme. Unabhängig von der Zeitraumauswahl.",
    ...
    labelAllPairs: "Alle Paare (24 Std.)",
    methodologyAllPairs:
