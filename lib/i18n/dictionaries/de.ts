...
const de = {
  ...
  home: {
    ...
    ariaStoryFilter: "Top-Meldungen nach Coin filtern",
    filterAll: "Alle",
    filterBitcoin: "Bitcoin-News",
    filterEthereum: "Ethereum-News",
    noStoriesForFilter: "Keine aktuellen Meldungen zu diesem Coin.",
  ...
  prices: {
    ...
    liveSourceLine: (time: string) => `Live · Binance-USDT-Paare · 24-Std.-Änderung · aktualisiert ${time}`,
